<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pta_social.aspx.cs" Inherits="ProjetoIntegrador.pta_social" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Plano Terapêutico para Alta Responsável - Serviço Social</title>
                ...
                <div class="col-lg-5 col-md-12 mb-3">
                    <div class="card sidebar-card h-100">
                        <div class="card-body pb-2">
                            <h5 class="fw-bold mb-3">Histórico de PTA Serviço Social</h5>
                            <asp:GridView 
                                ID="gvPtaSocial"
                                runat="server"
                                AutoGenerateColumns="False"
                                DataKeyNames="id_pta_social"
                                CssClass="table table-bordered table-hover"
                                Width="100%"
                                OnSelectedIndexChanged="gvPtaSocial_SelectedIndexChanged"
                                AllowPaging="False"
                                ShowHeader="True">
                                <Columns>
    ...
    <div>
        ...
        <asp:Button ID="btnSocial" CssClass="btn btn-primary mb-2" Text="Serviço Social" runat="server" OnClick="btnSocial_Click" />
                            ...
                            <div class="titulo mb-3">
                                <h2 class="fw-bold">Plano Terapêutico para Alta Responsável - Serviço Social</h2>
                            ...
                            <label class="form-label">Mora com alguém:</label><br />
                            <asp:CheckBox ID="chkSozinho" runat="server" Text="Sozinho" /><br />
                            <asp:CheckBox ID="chkConjuge" runat="server" Text="Cônjuge" /><br />
                            <asp:CheckBox ID="chkFilho" runat="server" Text="Filho(a)" /><br />
                            <asp:CheckBox ID="chkNoraGenro" runat="server" Text="Nora/Genro" /><br />
                            <asp:CheckBox ID="chkIrmao" runat="server" Text="Irmão(ã)" /><br />
                            <asp:CheckBox ID="chkInstitucionalizado" runat="server" Text="Institucionalizado" /><br />
                            <label>Outros:</label>
                            <asp:TextBox ID="txtOutrosMora" runat="server" CssClass="form-control mb-3" />

                            <!-- Pós-alta -->
                            <div class="line-1"></div>
                            <label class="form-label">Pós-alta residirá com:</label><br />
                            <asp:CheckBox ID="chkPosSozinho" runat="server" Text="Sozinho" /><br />
                            <asp:CheckBox ID="chkPosConjuge" runat="server" Text="Cônjuge" /><br />
                            <asp:CheckBox ID="chkPosFilho" runat="server" Text="Filho(a)" /><br />
                            <asp:CheckBox ID="chkPosNoraGenro" runat="server" Text="Nora/Genro" /><br />
                            <asp:CheckBox ID="chkPosIrmao" runat="server" Text="Irmão(ã)" /><br />
                            <asp:CheckBox ID="chkPosInstitucionalizado" runat="server" Text="Institucionalizado" /><br />
                            <label>Outros:</label>
                            <asp:TextBox ID="txtOutrosPosAlta" runat="server" CssClass="form-control mb-3" />
                            ...
                            <!-- Renda -->
                            <div class="line-1"></div>
                            <label class="form-label">Renda proveniente de:</label><br />
                            <asp:CheckBox ID="chkAposentadoria" runat="server" Text="Aposentadoria" /><br />
                            <asp:CheckBox ID="chkBolsa" runat="server" Text="Bolsa Família" /><br />
                            <asp:CheckBox ID="chkPensao" runat="server" Text="Pensão" /><br />
                            <asp:CheckBox ID="chkBPC" runat="server" Text="BPC" /><br />
                            <asp:CheckBox ID="chkSalario" runat="server" Text="Salário" /><br />
                            <label>Outros:</label>
                            <asp:TextBox ID="txtOutrosRenda" runat="server" CssClass="form-control mb-3" />

                            <!-- Ações desenvolvidas -->
                            <div class="line-1"></div>
                            <label class="form-label">Ações desenvolvidas:</label><br />
                            <asp:CheckBox ID="chkDireitos" runat="server" Text="Orientações sobre direitos/previdência" /><br />
                            <asp:CheckBox ID="chkNegligencia" runat="server" Text="Situação de negligência/violência" /><br />
                            <asp:CheckBox ID="chkEncaminhamento" runat="server" Text="Encaminhamento para rede básica de saúde" /><br />
