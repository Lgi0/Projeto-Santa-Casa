<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pta_enfermagem.aspx.cs" Inherits="ProjetoIntegrador.pta_enfermagem" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Plano Terapêutico para Alta Responsável</title>
                ...
                <div class="col-lg-5 col-md-12 mb-3">
                    <div class="card sidebar-card h-100">
                        <div class="card-body pb-2">
                            <h5 class="fw-bold mb-3">Histórico de PTA Enfermagem</h5>
                            <asp:GridView 
                                ID="gvPtas"
                                runat="server"
                                AutoGenerateColumns="False"
                                DataKeyNames="id_pta_enfermagem"
                                CssClass="table table-bordered table-hover"
                                Width="100%"
                                OnSelectedIndexChanged="gvPtas_SelectedIndexChanged"
                                AllowPaging="False"
                                ShowHeader="True">
                                <Columns>
    ...
    <div>
        ...
        <asp:Button ID="btnSocial" CssClass="btn btn-primary mb-2" Text="Serviço Social" runat="server" OnClick="btnSocial_Click" />
                            ...
                            <div class="titulo mb-3">
                                <h2 class="fw-bold">Plano Terapêutico para Alta Responsável - Enfermagem</h2>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox ID="txtInternacao" ReadOnly="true"  runat="server" CssClass="form-control" TextMode="Date" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <asp:CheckBox ID="chkCirurgico" runat="server" Text="Cirúrgico" /> &nbsp;
                                <br />
                                <label>Outros:</label>
                                <asp:TextBox ID="txtOutros" runat="server" CssClass="form-control mt-1" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nível de Consciência/Comportamento (Glasgow):</label>
                                <asp:TextBox ID="txtGlasgow" runat="server" CssClass="form-control" />
                            </div>
                            <div class="line-1"></div>
                            <label class="form-label">Paciente terá alta fazendo uso ou necessidade de:</label><br />
                            <asp:CheckBox ID="chkUlcera" runat="server" Text="Cuidados com úlcera de pressão" /><br />
                            <asp:CheckBox ID="chkEstomas" runat="server" Text="Estomas" /><br />
                            <asp:CheckBox ID="chkSonda" runat="server" Text="Sonda Vesical" /><br />
                            <asp:CheckBox ID="chkTraqueo" runat="server" Text="Traqueostomia" /><br />
                            <asp:CheckBox ID="chkOxigenio" runat="server" Text="Oxigênio" /><br />
                            <asp:CheckBox ID="chkAspiracao" runat="server" Text="Aspiração (orotraqueal ou endotraqueal)" /><br />
                            <asp:CheckBox ID="chkCurativos" runat="server" Text="Curativos" /><br />
                            <label>Outros:</label>
                            ...
                            <asp:CheckBox ID="chkFamiliar" runat="server" Text="Familiar/Cuidador" /> &nbsp;
                            <asp:CheckBox ID="chkOutro" runat="server" Text="Outro" />
                            <div class="mt-3">
                                <label class="form-label">Tipos de Orientações:</label><br />
                                <asp:CheckBox ID="chkCurativosOri" runat="server" Text="Para Curativos" /><br />
                                <asp:CheckBox ID="chkPrevencaoUlcera" runat="server" Text="Prevenção e cuidados com úlcera de pressão" /><br />
                                <asp:CheckBox ID="chkSondas" runat="server" Text="Cuidados com sondas/estomas" /><br />
                                <asp:CheckBox ID="chkAspiracaoOri" runat="server" Text="Aspiração de vias aéreas e traqueostomias" /><br />
                                <asp:CheckBox ID="chkDieta" runat="server" Text="Orientação da dieta assistida" /><br />
                                <asp:CheckBox ID="chkPele" runat="server" Text="Cuidados com a pele e higienização corporal" /><br />
                            </div>
                            <div class="line-1"></div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end mb-2">
                                <asp:Button 
                                    ...
                                    runat="server" 
                                    Text="Salvar" 
                                    CssClass="btn btn-success fw-bold px-5" OnClick="btnSalvar_Click"/>
